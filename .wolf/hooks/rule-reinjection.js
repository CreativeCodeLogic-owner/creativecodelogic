...
export function topRules(cerebrumContent, k = 3) {
...
export function readScopedRules(projectRoot) {
 ...
 */
export function scopedRulesForFiles(projectRoot, relFiles, maxTokens = 800) {
    ...
    for (const rule of rules) {
        ...
        if (relFiles.some((f) => regexes.some((re) => re.test(f)))) {
            ...
            if ((usedChars + snippet.length) / 3.5 > maxTokens)
                break;
...
//# sourceMappingURL=rule-reinjection.js.map