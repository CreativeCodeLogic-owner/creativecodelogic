...
> Auto-maintained by OpenWolf. Last scanned: 2026-08-01T09:01:50.855Z
...
- `CHANGELOG.md` — Changelog (~2313 tok)
...
- `verify6.mjs` — v6 verification: hero y-stability across 2 loops, comet ambient, matrix (~12668 tok)
